...
export default class VideoMoreSetting extends React.Component {
        ...
        <View style={styles.contentView}>
          <View style={styles.optionView}>
            {/* <TouchableOpacity style={[styles.itemView, {marginLeft: 40}]} onPress={this._onTapDownload}>
              <Image
                  source={require('../../assets/images/video/icon_video_download.png')}
            ...
            <TouchableOpacity style={[styles.itemView, {marginLeft: 40}]} onPress={this._onTapMute}>
              <Image
                  source={this.state.isMute ? require('../../assets/images/video/icon_video_muted.png') : require('../../assets/images/video/icon_video_mute.png')}
                  style={styles.imageItem}
              />
          ...
          <View style={styles.optionView}>
            ...
            <Image
                source={require('../../assets/images/video/icon_volume_off.png')}
            ...
            />
            <Image
                source={require('../../assets/images/video/icon_volume_up.png')}
